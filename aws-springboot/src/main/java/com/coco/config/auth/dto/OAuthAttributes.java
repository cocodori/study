package com.coco.config.auth.dto;
...
public class OAuthAttributes {
    ...
    * 가입할 때, 기본 권한을 GUEST로 주기 위해서 role빌더 값에는 Role.GUEST를 사용한다.
    * OAuthAttributes 클래스 생성이 끝나면, 같은 패키지 SessionUser클래스를 생성한다.
    * */
